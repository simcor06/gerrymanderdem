...
These three spatial data frames can than be used to create choropleth maps of voting age population in the state in each of the three levels of legislative districts.
