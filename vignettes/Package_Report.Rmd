...
In order to display the data and create readable maps, we used the `tamp` and `tmaptools` packages. These follow simialr coding rules as laid out in the tidyverse and the package `ggplot2`.  These packages allows users to change map projections easily, choose data frame information to display, and create and adjust map details easily .  Example code to create these choropleth maps looks like this:
...
# Discussion (Andrea Huerfano)

## Areas for Improvement
- Could use Census black to be more accurate
- could obtain prison and militrary base information
- the use of `sf` package may make process quicker
- could expand on further demographic information
- could make the projections for both determing area more accurate and displaying maps automated, whcih is supposedly a feature of the `sf` package.
