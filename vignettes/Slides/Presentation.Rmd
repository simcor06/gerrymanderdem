...
```{r out.width= "45%", out.height= "60%", fig.align='right'}
...
- Output is 3 `SpatialPolygonDataFrames` for each district type with associated demographic data (18 years adn older)
